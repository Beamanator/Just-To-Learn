 ...
 * they hear 'L' and left when they hear 'R'. The coach wants to know
 ...
 * left from right. In this case, only after the second, third and
 * fifth commands will the students face the same direction.
 * [see diagram online]
 */
lineUp = commands => 
    commands.split('') // convert to array of chars
    .reduce((t, e) => {
        // increment # of turns
        if (e == 'L' || e == 'R') t[1]++;
        
        // if even # of turns, person is standing same direction
        if (t[1] % 2 == 0) {
            t[0]++;
            t[1] = 0;
        }
