/**
 * Name: Make Array Consecutive 2
 * Core Arcade #: 42
 * 
 * Ratiorg got statues of different sizes as a present from CodeMaster
 * for his birthday, each statue having an non-negative integer
 * size. Since he likes to make things perfect, he wants to arrange
 * them from smallest to largest so that each statue will be bigger
...
makeArrayConsecutive2 = s =>
    s.sort((a,b) => a-b)[s.length-1] - s[0] - s.length + 1
