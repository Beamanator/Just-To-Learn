 ...
 * Here's why:
 * 
 * the first minute costs 3 cents, which leaves you with 20 - 3 = 17
 * cents;
 * the total cost of minutes 2 through 10 is 1 * 9 = 9, so you can talk
 * 9 more minutes and still have 17 - 9 = 8 cents;
 * each next minute costs 2 cents, which means that you can
 * talk 8 / 2 = 4 more minutes.
